...
## Phase 5: Read-it-Later

See **DESIGN.md § Saved Articles** for full schema, API, and implementation details.

Summary: Save arbitrary URLs to read later via bookmarklet. Works like a personal feed with read/unread and star states. Curated Lists for social sharing is a future addition.
