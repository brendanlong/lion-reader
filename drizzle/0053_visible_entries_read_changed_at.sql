-- Add read_changed_at to visible_entries view
-- This enables sorting entries by when their read state was last changed,
-- used by the "Recently Read" list feature.
