-- Replace e.updated_at with GREATEST(e.updated_at, ue.updated_at)
-- This gives the client a single "how current is this data" timestamp
-- that reflects changes to either the entry content or user state.
