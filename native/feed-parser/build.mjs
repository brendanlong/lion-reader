/**
 * Builds the native feed parser and copies the artifact to ./feed-parser.node.
 *
...
const names = {
  linux: "liblion_reader_feed_parser.so",
  darwin: "liblion_reader_feed_parser.dylib",
  win32: "lion_reader_feed_parser.dll",
};
...
copyFileSync(built, join(dir, "feed-parser.node"));
console.log(`Built native feed parser (${profile}) -> feed-parser.node`);
