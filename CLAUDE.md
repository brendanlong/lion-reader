...
- `terraform/` - DNS (Cloudflare), CDN (Bunny), Mailgun, and the domain registration as code, with its own README. **All DNS, Mailgun and registrar changes go here, not in a dashboard.**
