/**
 * Pure utility functions for parsing email From addresses.
 * These functions have no I/O dependencies and can be safely imported
 * by both webhook handlers and email processing modules.
 */
