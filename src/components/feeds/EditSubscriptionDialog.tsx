  ...
  return (
    <>
      <h2
        ...
        className="ui-text-xl mb-4 font-semibold text-zinc-900 dark:text-zinc-50"
      >
        Edit Subscription
      </h2>
      ...
      {/* Tags */}
      <div className="mb-6">
        <label className="ui-text-base mb-2 block font-medium text-zinc-700 dark:text-zinc-300">
          Tags
        </label>
        {tags.length === 0 ? (
            ...
            {tags.map((tag) => {
              ...
              return (
                <button
                  ...
                  disabled={isPending}
                  className={`ui-text-base flex items-center gap-1.5 rounded-full border px-3 py-1.5 transition-colors ${
                    isSelected
