...
const defaultButtonClassName =
  "ui-text-sm flex min-h-[44px] w-full items-center justify-center gap-3 rounded-md border border-edge-input bg-surface px-4 font-medium text-body transition-colors hover:bg-surface-muted focus:ring-2 focus:ring-focus focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50";
