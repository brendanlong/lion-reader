...
export function TagManagement() {
  ...
  if (isLoading) {
    return (
      <section>
        <h2 className="mb-4 text-xl font-semibold text-zinc-900 dark:text-zinc-50">Tags</h2>
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:flex-row sm:items-end">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="flex h-[42px] items-center gap-2 rounded-md border border-zinc-300 bg-white px-3 py-2 text-base transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"
          disabled={createMutation.isPending}
        >
      ...
      <div className="flex flex-col gap-3 rounded-md border border-zinc-300 bg-zinc-50 p-4 sm:flex-row sm:items-center dark:border-zinc-600 dark:bg-zinc-800/50">
        <div className="flex flex-1 items-center gap-3">
          ...
          <input
            ...
            className="flex-1 rounded-md border border-zinc-300 bg-white px-3 py-1.5 text-base text-zinc-900 focus:border-zinc-900 focus:ring-2 focus:ring-zinc-900 focus:ring-offset-2 focus:outline-none dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-zinc-400 dark:focus:ring-zinc-400"
            disabled={updateMutation.isPending}
            autoFocus
          />
        </div>
  ...
  return (
    <div className="flex items-center justify-between rounded-md border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/50">
      <div className="flex items-center gap-3">
        <ColorDot color={tag.color} size="lg" />
        <div>
          <p className="text-base font-medium text-zinc-900 dark:text-zinc-50">{tag.name}</p>
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
