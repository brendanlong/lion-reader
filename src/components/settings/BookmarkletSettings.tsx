  ...
  return (
    <section>
      ...
      <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="mt-4">
          <p className="ui-text-base mb-3 text-zinc-700 dark:text-zinc-300">
        ...
        <div className="mt-6 border-t border-zinc-200 pt-6 dark:border-zinc-700">
          ...
          {showCode && (
            <div className="mt-4">
              <p className="ui-text-base mb-2 text-zinc-500 dark:text-zinc-400">
