...
const article: DemoArticle = {
  ...
  contentHtml: `
    ...
    <ul>
      ...
      <li><strong>Yours to own</strong> &mdash; Free and <a href="/demo/all?entry=open-source">open source</a>, straightforward to self-host with Docker. No ads, no data selling, and nothing that records what you read.</li>
    </ul>
