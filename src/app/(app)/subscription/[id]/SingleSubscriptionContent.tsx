...
function SingleSubscriptionContentInner() {
  ...
  // Derive values from subscription (if available)
  ...
  const siteUrl = subscription ? (subscription as { siteUrl?: string }).siteUrl : null;
    ...
    <>
      ...
      <div className={`mx-auto max-w-3xl px-4 py-4 sm:p-6 ${page.openEntryId ? "hidden" : ""}`}>
        <div className="mb-4 sm:mb-6">
          ...
          {/* Feed title and unread count - show skeleton only if we have no data at all
