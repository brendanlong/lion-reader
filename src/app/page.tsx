  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 px-4 dark:bg-zinc-950">
      <main className="w-full max-w-2xl text-center">
        ...
        <p className="ui-text-lg mt-4 text-zinc-600 dark:text-zinc-400">
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-3">
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            <h3 className="ui-text-lg font-semibold text-zinc-900 dark:text-zinc-50">Open API</h3>
            <p className="ui-text-sm mt-2 text-zinc-600 dark:text-zinc-400">
