...
const article: DemoArticle = {
  ...
  contentHtml: `
    ...
    <ul>
      ...
      <li><strong>Obsessively fast</strong> &mdash; New entries are patched straight into the list you&rsquo;re reading with no refetch and no re-render jank, and in-app navigation is served from cache with zero server round-trips. See the <strong>Obsessive Performance</strong> article for how.</li>
