...
const article: DemoArticle = {
  ...
  starred: false,
  summaryHtml: `<p>Lion Reader offers <strong>on-demand AI summaries</strong> to help triage unread articles. Unlike auto-summarizing readers, summaries are only generated when you click &quot;Summarize.&quot; Results are <strong>cached and shared across users</strong> to reduce costs. Configure your preferred model in settings and quickly scan summaries to prioritize your reading list.</p>`,
  contentHtml: `
    <h2>AI Summaries</h2>
