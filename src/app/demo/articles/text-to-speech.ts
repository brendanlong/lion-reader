...
const article: DemoArticle = {
  ...
  contentHtml: `
    <figure>
      <img src="/demo/text-to-speech.png" alt="The Lion Reader lion wearing headphones and reading a newspaper as an article is read aloud, with sound waves rising from the page." />
    </figure>
