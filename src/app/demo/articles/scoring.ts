...
const article: DemoArticle = {
  ...
  starred: false,
  summaryHtml: `<p>Lion Reader learns your preferences through explicit voting and implicit signals like starring or marking entries read. After 20+ ratings, it trains an <strong>on-device ML model</strong> using TF-IDF and Ridge Regression to predict scores for new content, with all processing happening locally in your browser via ONNX Runtime WebAssembly.</p>`,
  contentHtml: `
