...
const article: DemoArticle = {
  ...
  contentHtml: `
    ...
    <p>Setting up is straightforward. In your RSS app, look for &ldquo;Google Reader&rdquo; or &ldquo;Google Reader API&rdquo; as the service type, then enter:</p>

    <ol>
      <li><strong>Server URL</strong> &mdash; Your Lion Reader instance URL (e.g., <code>https://lionreader.com</code>)</li>
