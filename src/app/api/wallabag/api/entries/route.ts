...
export async function POST(request: Request): Promise<Response> {
  ...
  // Handle archive/starred flags if provided. returnCounts: false — this route
  // discards the return value, so the service skips the visible_entries count
  // scans except when a real change publishes (which still carries full counts);
  // see #1045/#1046.
