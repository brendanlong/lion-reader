...
class EntryStateDaoTest {
    ...
    fun setUp() =
        runTest {
            ...
            database =
                Room
                    .inMemoryDatabaseBuilder(context, LionReaderDatabase::class.java)
    ...
    @Test
    fun getStateReturnsNullWhenNotFound() =
        runTest {
    ...
    @Test
    fun upsertStateReplacesExisting() =
        runTest {
            val initialState =
                EntryStateEntity(
                    entryId = "entry-1",
    ...
    @Test
    fun setStarredUpdatesStarredState() =
        runTest {
    ...
    @Test
    fun clearPendingSyncClearsFlag() =
        runTest {
